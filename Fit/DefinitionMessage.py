...
class DefinitionMessage(Data):
    ...
    known_messages = {
        ...
        55  : [ 'monitoring', { 0 : Field('device_index'), 1 : CaloriesField('calories'),
                                2 : DistanceField('distance', FieldStats.stats_commulative),
                                3 : CyclesField(), 4 : TimeMsField('cum_active_time', FieldStats.stats_commulative),
                                5 : ActivityTypeField(),
                                ...
                                34 : TimeMinField('vigorous_activity', FieldStats.stats_all),
